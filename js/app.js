(function() {
  ...
  function deckClicked(event) {
    ...
    if (
      event.target.classList.contains("deck__card") &&
  ...
  function showModal() {
    ...
    document
      .getElementById("modalYesBtn")
      .addEventListener("click", modalYesClicked);
    document
      .getElementById("modalNoBtn")
      .addEventListener("click", modalNoClicked);
  ...
  function closeModal() {
    document
      .getElementById("modalYesBtn")
      .removeEventListener("click", modalYesClicked);
    document
      .getElementById("modalNoBtn")
      .removeEventListener("click", modalNoClicked);
